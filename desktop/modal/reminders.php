...
?>
    ...
    <table class="table table-condensed tablesorter" id="table_healthNetwork">
        ...
        foreach ($json as $item) {
            ...
            switch ($item['type']) {
                case "Alarm":
                    $type = '<span class="label label-' . $couleur . '" style="font-size : 1em;" title="{{Alarme}}"><i class="fas fa-bell"></i> Alarme</span>';
                    break;
                case "MusicAlarm":
                ...
                case "Timer":
                    ...
                    break;
                default:
                    $type = '<span class="label label-' . $couleur . '" style="font-size : 1em;" title="{{????}}"><i class="fas fa-bell"></i> ????</span>';
                    break;
            }
    ...
    <a class="btn btn-default pull-right refreshAction" data-action="refresh"><i class="fas fa-refresh"></i>
        {{Rafraichir}}</a>
