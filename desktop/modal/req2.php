...
' style="height: 40px;"></textarea>
    <textarea class="form-control marketAttr" id="requetedata"
              placeholder='{"behaviorId":"PREVIEW","sequenceJson":"{\"@type\":\"com.amazon.alexa.behaviors.model.Sequence\",\"startNode\":{\"@type\":\"com.amazon.alexa.behaviors.model.OpaquePayloadOperationNode\",\"operationPayload\":{\"deviceType\":\"A3S5BH2HU6VAYF\",\"deviceSerialNumber\":\"GGGGGGGGGGGGGGGG\",\"locale\":\"fr-FR\",\"customerId\":\"AAAAAAAAAAAAAA\",\"value\":50},\"type\":\"Alexa.DeviceControls.Volume\"}}","status":"ENABLED"}'
              style="height: 90px;"></textarea>
    <a class="btn btn-success pull-left" id="bt_Lancer"><i class="far jeedomapp-done"></i> {{Lancer}}</a> <input
        style="position:relative;top:+10px;left:+25px;" type="checkbox" id="requeteremotevidecache"/> <span
        style="position:relative;top:+7px;left:+20px;">Vider le log au lancement</span><a
        class="btn btn-danger pull-right" id="bt_logdisplayremoveLog"><i class="far fa-trash-alt"></i> {{Supprimer}}</a>
    <a class="btn btn-warning pull-right" id="bt_logdisplayclearLog"><i class="fas fa-times"></i> {{Vider}}</a>
    <a class="btn btn-success pull-right" id="bt_logdisplaydownloadLog"><i class="fas fa-cloud-download-alt"></i>
        {{Télécharger}}</a>
    <a class="btn btn-warning pull-right" data-state="1" id="bt_eventLogStopStart"><i class="fas fa-pause"></i>
        {{Pause}}</a>
    <input class="form-control pull-right" id="in_eventLogSearch" style="width : 200px;margin-left:5px;"
