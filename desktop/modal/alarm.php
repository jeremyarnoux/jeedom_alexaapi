...
<a class="btn btn-success pull-right" id="md_eventEditSave" style="color: white;"><i class="fas fa-check-circle"></i>
    {{Enregistrer}}</a>
<?php
if (is_object($event)) {
    echo '<a class="btn btn-warning pull-right" id="md_eventEditDuplicate" style="color: white;"><i class="far fa-copy"></i> {{Duplication}}</a>';
