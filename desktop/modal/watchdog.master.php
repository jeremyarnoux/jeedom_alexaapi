...
<div class="row row-overflow">
    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-4">
        <div class="bs-sidebar">
            <ul id="ul_eqLogic" class="nav nav-list bs-sidenav">
                <a class="btn btn-default watchdogMasterAction"
                   style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add"><i
                            class="fas fa-plus-circle"></i> {{Ajouter un Jeedom cible}}</a>
    ...
    <div class="col-lg-10 col-md-9 col-sm-8 col-xs-8 watchdogMaster"
         style="border-left: solid 1px #EEE; padding-left: 25px;display:none;">
        <a class="btn btn-success watchdogMasterAction pull-right" data-action="save"><i
                    class="fas fa-check-circle"></i> {{Sauvegarder}}</a>
        <a class="btn btn-danger watchdogMasterAction pull-right" data-action="remove"><i
                    class="fas fa-minus-circle"></i> {{Supprimer}}</a>

        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#watchdogMasterConfigtab" aria-controls="home" role="tab"
                                                      data-toggle="tab"><i class="fas fa-tachometer-alt"></i>
                    {{Configuration}}</a></li>
            <li role="presentation"><a href="#watchdogMasterAffecttab" aria-controls="profile" role="tab"
                                       data-toggle="tab"><i class="fas fa-list-alt"></i> {{Affectation}}</a></li>
        </ul>
        ...
        <div class="tab-content" style="height:calc(100% - 50px);overflow:auto;overflow-x: hidden;">
                ...
                <form class="form-horizontal">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="watchdogMasterAttr form-control" data-l1key="id"
                                       style="display : none;"/>
                                <input type="text" class="watchdogMasterAttr form-control" data-l1key="name"
                                       placeholder="{{Nom du jeedom cible}}"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="watchdogMasterAttr form-control" data-l1key="configuration"
                                        data-l2key="network::access">
            ...
            <div role="tabpanel" class="tab-pane" id="watchdogMasterAffecttab">
                <a class="btn btn-success btn-sm pull-right" id="bt_watchdogMasterAddEqLogic"><i
                            class="fas fa-plus-circle"></i> {{Ajouter un équipement}}</a><br>
                <form class="form-horizontal">
                    <fieldset>
