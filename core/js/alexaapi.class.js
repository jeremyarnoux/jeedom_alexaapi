 ...
 */
 ...
 jeedom.openzwave.node.button = function (_params) {
 	...
 	paramsAJAX.url = 'plugins/openzwave/core/php/jeeZwaveProxy.php';
 	paramsAJAX.data = {
 		request: '/node?node_id='+_params.node_id+'&instance_id='+_params.instance+'&cc_id='+jeedom.openzwave.normalizeClass(_params.class)+'&index='+_params.index+'&type=buttonaction&action='+_params.action,
 	};
 	$.ajax(paramsAJAX);
 }
