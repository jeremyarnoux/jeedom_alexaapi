...
<center>
    ...
    <a class="btn btn-warning btn-sm bt_identificationCookie2"><i class="fas fa-clock"></i> {{... Attendez la génération
        du Cookie Amazon ...}} </a>
    <a class="btn btn-default btn-sm bt_identificationCookie2bis"><i class="fas fa-clock"></i> {{... Attendez la
        génération du Cookie Amazon ...}} </a>
    <a class="btn btn-danger btn-sm bt_identificationCookie2echec"><i class="fas fa-times"></i> {{La génération du
        Cookie Amazon a échoué}} </a>
    <a class="btn btn-success btn-sm bt_identificationCookie3"><i class="fas fa-check"></i> {{Bravo : Cookie
        d'identification Amazon chargé !}} </a>
    <a class="btn btn-primary btn-sm bt_identificationCookie"><i class="fas fa-spinner fa-spin"></i> {{Ouverture de la
        fenetre d'identification Amazon Alexa en cours ...}} </a>
...
<center>
    <a class="btn btn-danger btn-sm" id="bt_reinstallNodeJS"><i class="fas fa-recycle"></i> {{Réparation de NodeJS}}
    </a>
</center>
...
<form class="form-horizontal">
    <fieldset>
        ...
        <div class="form-group">
            <label class="col-lg-4 control-label">{{Activer les fonctions réservées aux utilisateurs
                expérimentés}}</label>
            <div class="col-lg-3">
        ...
        <div class="form-group">
            <label class="col-lg-4 col-md-3 col-sm-4 col-xs-6 control-label">{{Recharger la configuration par défaut de
        ...
        <div class="form-group">
            <label class="col-lg-4 col-md-3 col-sm-4 col-xs-6 control-label">{{Supprimer tous les devices !! et relancer
                un Scan}}</label>
            <div class="col-lg-3 col-md-4 col-sm-5 col-xs-6">
                <a class="btn btn-danger bt_supprimeTouslesDevices"><i class="fas fa-exclamation-triangle"></i>
                    {{Lancer}}</a>
            </div>
        </div>
    </fieldset>
...
<form class="form-horizontal">
    <fieldset>
        ...
        <div class="form-group">
            ...
            <a class="btn btn-success btn-xs pull-left" id="bt_saveUpdateRoutines"><i class="fas fa-sync"></i> {{Avancer
                la mise à jour}}</a>
        </div>
    </fieldset>
</form>
