...
<center>
	...
	<a class="btn btn-warning btn-sm bt_identificationCookie2"><i class="fas fa-clock"></i> {{... Attendez la génération du Cookie Amazon ...}} </a>
	<a class="btn btn-default btn-sm bt_identificationCookie2bis"><i class="fas fa-clock"></i> {{... Attendez la génération du Cookie Amazon ...}} </a>
